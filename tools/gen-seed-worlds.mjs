...
//
//   node tools/gen-seed-worlds.mjs > netlify/database/migrations/20260607121000_seed_worlds.sql
//
// Deterministic: re-running produces the same SQL. The claim flow never INSERTs
// worlds, so this file defines the entire universe supply.
...
function main() {
  ...
  const lines = [];
  lines.push('-- Seed the first universe: a FIXED, hand-tuned collection of distinct worlds.');
